...
Preserve Omissions: If optional sections or arrays are empty (e.g., learningRoadmap or jobRecommendations under Goal A), you must generate a concise, job-specific learning roadmap and up to 3 relevant job recommendations that help the candidate become a stronger fit for the uploaded job description.
